...
import com.jd.core.v1.model.classfile.attribute.*;
import com.jd.core.v1.model.classfile.attribute.ElementValue;
import com.jd.core.v1.model.classfile.attribute.ElementValuePair;
import com.jd.core.v1.model.classfile.constant.*;
import com.jd.core.v1.model.javasyntax.expression.*;
import com.jd.core.v1.model.javasyntax.reference.*;
...
public class AnnotationConverter implements ElementValueVisitor {
    ...
    protected com.jd.core.v1.model.javasyntax.reference.ElementValue elementValue = null;
        ...
        if (elementValuePairs == null) {
            ...
            if ("value".equals(elementName)) {
                ...
                return new AnnotationReference(
                        ot,
                        new com.jd.core.v1.model.javasyntax.reference.ElementValuePair(elementName, convert(elementValue)));
            }
        } else {
            ...
            for (ElementValuePair elementValuePair : elementValuePairs) {
                String elementName = elementValuePair.getElementName();
                ElementValue elementValue = elementValuePair.getElementValue();
                list.add(new com.jd.core.v1.model.javasyntax.reference.ElementValuePair(elementName, convert(elementValue)));
            }
    ...
    public com.jd.core.v1.model.javasyntax.reference.ElementValue convert(ElementValue ev) {
        ev.accept(this);
        return elementValue;
    }
