...
package com.jd.core.v1.service.converter.classfiletojavasyntax.util;

import com.jd.core.v1.model.classfile.ClassFile;
import com.jd.core.v1.model.classfile.ConstantPool;
import com.jd.core.v1.model.classfile.Method;
import com.jd.core.v1.model.classfile.attribute.AttributeBootstrapMethods;
import com.jd.core.v1.model.classfile.attribute.AttributeCode;
import com.jd.core.v1.model.classfile.attribute.BootstrapMethod;
import com.jd.core.v1.model.classfile.constant.*;
...
import com.jd.core.v1.service.converter.classfiletojavasyntax.model.cfg.BasicBlock;
import com.jd.core.v1.service.converter.classfiletojavasyntax.model.cfg.ControlFlowGraph;
...
import com.jd.core.v1.service.converter.classfiletojavasyntax.model.javasyntax.statement.ClassFileMonitorEnterStatement;
import com.jd.core.v1.service.converter.classfiletojavasyntax.model.javasyntax.statement.ClassFileMonitorExitStatement;
...
import com.jd.core.v1.service.converter.classfiletojavasyntax.visitor.SearchFirstLineNumberVisitor;
import com.jd.core.v1.util.DefaultList;
import com.jd.core.v1.util.DefaultStack;

import java.util.*;

import static com.jd.core.v1.model.javasyntax.declaration.Declaration.FLAG_PRIVATE;
import static com.jd.core.v1.model.javasyntax.declaration.Declaration.FLAG_STATIC;
import static com.jd.core.v1.model.javasyntax.declaration.Declaration.FLAG_SYNTHETIC;
import static com.jd.core.v1.model.javasyntax.statement.ReturnStatement.RETURN;
...
public class ByteCodeParser {
        ...
        for (int offset=fromOffset; offset<toOffset; offset++) {
            ...
            switch (opcode) {
                ...
                case 182: case 183: case 184: case 185: // INVOKEVIRTUAL, INVOKESPECIAL, INVOKESTATIC, INVOKEINTERFACE
                    ...
                    TypeMaker.MethodTypes methodTypes = typeMaker.makeMethodTypes(ot.getInternalName(), name, descriptor);
                        ...
                        if (TYPE_VOID.equals(methodTypes.returnedType)) {
                            if ((opcode == 183) && // INVOKESPECIAL
                                ...
                                if (expression1.getClass() == ClassFileNewExpression.class) {
                                    ...
                                    statements.add(new ExpressionStatement(typeParametersToTypeArgumentsBinder.newConstructorInvocationExpression(
                                        lineNumber, ot, descriptor, methodTypes, parameters)));
                                } else {
                                    statements.add(new ExpressionStatement(typeParametersToTypeArgumentsBinder.newSuperConstructorInvocationExpression(
                                        lineNumber, ot, descriptor, methodTypes, parameters)));
                                }
                            } else {
    ...
    private void parseGetStatic(DefaultStack<Expression> stack, ConstantPool constants, int lineNumber, int index) {
        ...
        Type type = typeMaker.makeFieldType(ot.getInternalName(), name, descriptor);
    ...
    private void parseGetField(DefaultStack<Expression> stack, ConstantPool constants, int lineNumber, int index) {
        ...
        stack.push(typeParametersToTypeArgumentsBinder.newFieldReferenceExpression(
            lineNumber, type, getFieldInstanceReference(objectRef, ot,  name), ot, name, descriptor));
    }
    ...
    private void parsePutField(Statements statements, DefaultStack<Expression> stack, ConstantPool constants, int lineNumber, int index) {
        ...
        Expression valueRef = stack.pop();
        Expression objectRef = stack.pop();
        FieldReferenceExpression fieldRef = typeParametersToTypeArgumentsBinder.newFieldReferenceExpression(
            lineNumber, type, getFieldInstanceReference(objectRef, ot,  name), ot, name, descriptor);
        parsePUT(statements, stack, lineNumber, fieldRef, valueRef);
    }
